...
__global__ void multiplyVector2D(float* A, size_t pitch_A, float* B, size_t pitch_B, float* C, size_t pitch_C, int width_A, int height_A, int width_B, int height_B, int width_C, int height_C) {
